...
const FlightResults: React.FC<FlightResultsProps> = ({ 
  ...
  const [showInterviewMessage, setShowInterviewMessage] = useState(false);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                ...
                <div className="text-center lg:text-right lg:ml-8 flex-shrink-0">
                  ...
                  <div className="relative group">
                    <button 
                      className="bg-gradient-to-r from-primary-500 to-secondary-500 text-white px-6 sm:px-8 py-2 sm:py-3 rounded-lg font-semibold hover:from-primary-600 hover:to-secondary-600 transition-all duration-200 hover:shadow-lg transform hover:-translate-y-1 text-sm sm:text-base w-full sm:w-auto"
                      onClick={() => setShowInterviewMessage(true)}
                    >
                      Book Now
                    </button>
                    <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 px-4 py-2 bg-gray-800 text-white text-sm rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-50">
                      🚀 Big things coming! This is just a small mock up of what I have planned! ✨
      ...
      {showInterviewMessage && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl">
            <div className="text-center">
              <div className="text-6xl mb-4">🚀</div>
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Big things coming!</h3>
              <p className="text-gray-600 mb-6 leading-relaxed">
                This is just a small mock up of what I have planned! ✨
              </p>
              <p className="text-sm text-gray-500 mb-6">
                Cya soon @interview (girl can dream)
              </p>
              <button 
                onClick={() => setShowInterviewMessage(false)}
                className="bg-gradient-to-r from-primary-500 to-secondary-500 text-white px-8 py-3 rounded-lg font-semibold hover:from-primary-600 hover:to-secondary-600 transition-all duration-200 hover:shadow-lg"
              >
                Awesome! ✨
              </button>
            </div>
